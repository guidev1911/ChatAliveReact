...
return (
  ...
  >
    ...
    <motion.div
      ...
      className="relative z-10 bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl shadow-2xl p-10 max-w-md w-full border border-white/20"
    >
      {formMode === "login" ? (
        <>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-white/20 text-white placeholder-gray-300 border border-white/30 focus:outline-none focus:ring-2 focus:ring-cyan-400"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2 bg-gradient-to-r from-cyan-400 to-cyan-600 hover:from-cyan-700 hover:to-cyan-500 text-white font-bold rounded-lg transition-all duration-300 disabled:opacity-50 shadow-lg"
            >

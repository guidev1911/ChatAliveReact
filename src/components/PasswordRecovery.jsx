  ...
  return (
    <div>
      ...
      <AnimatePresence mode="wait">
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-white/20 text-white placeholder-gray-300 border border-white/30 focus:outline-none focus:ring-2 focus:ring-green-400"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2 bg-gradient-to-r from-green-600 to-green-400 hover:from-green-700 hover:to-green-500 text-white font-bold rounded-lg transition-all duration-300 shadow-lg disabled:opacity-50"
            >
        ...
        {step === 2 && (
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg transition duration-300 shadow-lg disabled:opacity-50"
            >
        ...
        {step === 3 && (
          <motion.div key="step3" {...animation} className="text-center text-green-300 text-sm">
      ...
      {step !== 3 && (
        <button
          type="button"
          onClick={onBackToLogin}
          className="w-full text-sm text-green-300 hover:underline mt-6"
        >
          Voltar para login
        </button>
      )}
